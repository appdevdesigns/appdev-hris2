...
function(){
    ...
    AD.controllers.opstools.BalanceReportTool.BalanceReportUpload = can.Control.extend({


        init: function( element, options ) {
            var self = this;
            this.options = AD.defaults({
                    templateDOM: 'opstools/BalanceReportTool/views/BalanceReportUpload/BalanceReportUpload.ejs',
            }, options);
