...
function(){
    ...
    AD.controllers.opstools.BalanceReportTool.BalanceReportSend = can.Control.extend({


        init: function( element, options ) {
            var self = this;
            this.options = AD.defaults({
                    templateDOM: 'opstools/BalanceReportTool/views/BalanceReportSend/BalanceReportSend.ejs',
            }, options);
