...
function(){
    ...
    AD.controllers.opstools.BalanceReportTool.BalanceReportReview = can.Control.extend({


        init: function( element, options ) {
            var self = this;
            this.options = AD.defaults({
                    templateDOM: 'opstools/BalanceReportTool/views/BalanceReportReview/BalanceReportReview.ejs',
            }, options);
