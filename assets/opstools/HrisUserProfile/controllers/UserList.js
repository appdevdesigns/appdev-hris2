    ...
    AD.controllers.opstools.HrisUserProfile.UserList = can.Control.extend({
        ...
        init: function( element, options ) {
            ...
            AD.comm.hub.subscribe('hrisuserprofile.resize', function (key, data) {
				...
				var buttonHeight = self.element.find(".hris-widget-bottom-btn").outerHeight(true);				
				...
				self.element.find('.hris-nav-list').css("height", (data.height - mastheadHeight -5 - buttonHeight) + "px");
